    ...
    <header className="sticky top-0 z-50 w-full border-b border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container flex h-14 max-w-7xl items-center justify-between px-4 md:px-6">
        ...
        <div className="flex items-center gap-2">
          <Link href="/agents">
            <a className="text-sm font-medium text-muted-foreground hover:text-foreground transition-colors px-3 py-2 rounded-md hover-elevate active-elevate-2" data-testid="link-agents">
              Agents
            </a>
          </Link>
          <ThemeToggle />
